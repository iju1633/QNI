...
public class SettingController {
    ...
    public ResponseEntity<ChangeNicknameResponseDTO> changeNickname(@RequestBody ChangeNicknameDTO changeNicknameDTO) {


        return ResponseEntity.ok().body(settingService.changeNickname(changeNicknameDTO));
    }
